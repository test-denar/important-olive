    ...
    render() {
        ...
        return (
            <footer id="footer">
                                ...
                                <ul class="icons bulleted">
                                    {_.map(_.get(this.props, 'pageContext.site.data.footer.contact_methods.methods_col1'), (method, method_idx) => (
                                        (_.get(method, 'type') === 'contact_with_text') ? 
                                            <li key={method_idx} class={'icon ' + _.get(method, 'icon')}>
                ...
                <p class="copyright">{_.get(this.props, 'pageContext.site.data.footer.copyright.enabled') && <React.Fragment>{htmlToReact(_.get(this.props, 'pageContext.site.data.footer.copyright.text'))}<br /></React.Fragment>}
                    {
